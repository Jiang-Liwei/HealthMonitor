...
const (
	// Label holds the string label denoting the foodnutrientsrelationships type in the database.
	Label = "food_nutrients_relationships"
	...
	// Table holds the table name of the foodnutrientsrelationships in the database.
	Table = "food_nutrients_relationships"
...
// Columns holds all SQL columns for foodnutrientsrelationships fields.
var Columns = []string{
	FieldID,
}

// ForeignKeys holds the SQL foreign-keys that are owned by the "food_nutrients_relationships"
...
// OrderOption defines the ordering options for the FoodNutrientsRelationships queries.
