...
const (
	// Label holds the string label denoting the adminjwtblacklist type in the database.
	Label = "admin_jwt_blacklist"
	...
	// Table holds the table name of the adminjwtblacklist in the database.
	Table = "admin_jwt_blacklists"
)

// Columns holds all SQL columns for adminjwtblacklist fields.
var Columns = []string{
	FieldID,
	FieldJti,
	FieldExpiresAt,
